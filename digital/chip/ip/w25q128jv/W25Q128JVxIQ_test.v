/******************************************************************************
 ...
 Verilog TestBench for W25Q128JVxIQ series Serial Flash Memory
...
module test_25Q128JVxIQ;

`include "W25Q128JVxIQ_inc.v"

W25Q128JVxIQ dut(CSn, CLK, DIO, DO, WPn, HOLDn);
...
//  	spi_wait_busy(1000000);
  ...
  $display("Read with Quad Output - QPI: %0t", $time);
