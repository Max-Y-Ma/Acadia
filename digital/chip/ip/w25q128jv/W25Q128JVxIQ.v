...
/******************************************************************************
 ...
 Verilog Simulation for W25Q128JVxIQ series Serial Flash Memory
 ...
 Versions:
	09/19/2016	V0.1		Initial Version
	03/17/2021	V1.0		Updated SFDP/Security Register3

******************************************************************************/

`timescale 1ns / 1ps

module W25Q128JVxIQ (CSn, CLK, DIO, DO, WPn, HOLDn);

`include "W25Q128JVxIQ_inc.v"
...
`define MEM_FILENAME   {getenv("ECE411_MEMLST"), "_flash.lst"}	// Memory contents file(s)
`define SECSI_FILENAME {getenv("IP_DIR"), "/w25q128jv/SECSI.TXT"}
`define SFDP_FILENAME  {getenv("IP_DIR"), "/w25q128jv/SFDP.TXT"}
`define SREG_FILENAME  {getenv("IP_DIR"), "/w25q128jv/SREG.TXT"}
