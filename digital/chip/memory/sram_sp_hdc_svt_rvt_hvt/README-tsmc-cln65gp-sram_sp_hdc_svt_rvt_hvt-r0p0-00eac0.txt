ARM, Inc.
High Density Single-Port Sram Compiler (SRAM_SP_HDC_SVT_RVT_HVT) Release Notes
TSMC CLN65GP 65nm Process, 0.525um^2 Bit Cell
-----------------------------------------------------------------------------------------------
r0p0-00eac0 (10/06/2010)
...
This section lists all of the foundry documents and technology files used to design this product.
    ...
    o SRAM 6T 1.05um by 0.5um (0.525um^2) Cell
        - 065_LP_M4_v1d1_demo_array_4x4.gds V1.1 (09/18/2009)
    ...
    o Process Spice Models
        - Bit Cell SPICE Models  T-N65-CL-CL-007 6T 0.525um^2 V1.0 (08/31/2006)
...
This section lists the EDA tools and versions supported for this product release. The items indicated by the "*" were used during the QA testing of this release.This set of tools and versions corresponds to ARM EDA Package 6.2-65.
...
This section describes known problems and work-arounds as of the release date of this library.
	...
	for instances. These may be ignored.
     o  Calibre LVS and HLVS may flag the ERC error "ERC PATHCHK ! POWER && ! GROUND NOFLOAT"
        for instances. These may be ignored.
     o  Calibre LVS and HLVS may flag the ERC error "ERC PATHCHK ! LABELED NOFLOAT"
        for instances. These may be ignored.
	...
	These floating nwells also appear as isolated nets. These may be ignored.
     ...
     o  The Dynamic power does not increase w.r.t increase in coloumn and rows
        for some instances	
